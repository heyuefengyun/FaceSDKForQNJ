...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FaceSDKForQNJ.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Jing/FaceSDKForQNJ'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jing' => '841653650@qq.com' }
  s.source           = { :git => 'https://github.com/Jing/FaceSDKForQNJ.git', :tag => s.version.to_s }
